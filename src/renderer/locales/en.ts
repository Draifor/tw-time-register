const en = {
  translations: {
    ...
    reports: {
      ...
      to: 'To',
      tasks: 'Tasks',
      taskSearchPlaceholder: 'Search task by name...',
      allTasks: 'Showing all tasks',
      matchingTasks: '{{count}} task(s) match your search',
      clear: 'Clear',
    ...
    tasks: {
      ...
      importTW: {
        ...
        resolveTitle: 'Resolve duplicates',
        resolveSubtitle: 'These tasks already exist in your DB. Decide whether to keep them or update them.',
        keepExisting: 'Keep',
        ...
        applyError: 'There were {{count}} error(s) while applying changes'
      },
      importCSV: {
        trigger: 'Import CSV',
