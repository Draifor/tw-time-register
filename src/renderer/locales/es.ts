const es = {
  translations: {
    ...
    reports: {
      ...
      to: 'Hasta',
      tasks: 'Tareas',
      taskSearchPlaceholder: 'Buscar tarea por nombre...',
      allTasks: 'Mostrando todas las tareas',
      matchingTasks: '{{count}} tarea(s) coinciden con la búsqueda',
      clear: 'Limpiar',
    ...
    tasks: {
      ...
      importTW: {
        ...
        duplicateLinksWarning: 'Se detectaron {{count}} links duplicados en tu BD. Se usará la primera coincidencia.',
        ...
        alreadyLinkedCount: '{{count}} tarea(s) ya estaban enlazadas y no cambiarán.',
        duplicatesFound: 'Se encontraron {{count}} tarea(s) ya enlazadas. Decide si deseas actualizar sus datos.',
        ...
        reviewDuplicatesBtn: 'Revisar duplicados',
        resolveTitle: 'Resolver duplicados',
        resolveSubtitle: 'Estas tareas ya existen en tu BD. Decide si deseas conservarlas o actualizarlas.',
        keepExisting: 'Conservar',
        ...
        currentLabel: 'Actual',
        newLabel: 'Nuevo',
        applyImportBtn: 'Aplicar cambios',
        ...
        importAppliedDesc: '{{created}} nuevas, {{updated}} actualizadas, {{skipped}} sin cambios',
        noChanges: 'No hubo cambios para aplicar',
        applyError: 'Hubo {{count}} error(es) al aplicar los cambios'
      },
      importCSV: {
